/// \ingroup vtk
/// \class ttkScalarFieldCriticalPointsPL
...
///   - standalone/ScalarFieldCriticalPointsPL/main.cpp
///
...
///
/// \sa ttk::ScalarFieldCriticalPointsPL
///
/// \b Online \b examples: \n
...
// VTK Module
#include <ttkScalarFieldCriticalPointsPLModule.h>
...
class TTKSCALARFIELDCRITICALPOINTSPL_EXPORT ttkScalarFieldCriticalPointsPL
  : public ttkAlgorithm,
    protected ttk::ScalarFieldCriticalPointsPL {

public:
  static ttkScalarFieldCriticalPointsPL *New();

  vtkTypeMacro(ttkScalarFieldCriticalPointsPL, ttkAlgorithm);
...
protected:
  ttkScalarFieldCriticalPointsPL();

  ~ttkScalarFieldCriticalPointsPL() override;
