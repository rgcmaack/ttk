...
vtkStandardNewMacro(ttkScalarFieldCriticalPointsPL);

ttkScalarFieldCriticalPointsPL::ttkScalarFieldCriticalPointsPL() {
...
int ttkScalarFieldCriticalPointsPL::FillInputPortInformation(
...
int ttkScalarFieldCriticalPointsPL::FillOutputPortInformation(
  int port, vtkInformation *info) {
  if(port == 0)
...
int ttkScalarFieldCriticalPointsPL::RequestData(
