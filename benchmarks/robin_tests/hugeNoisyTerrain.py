...
datasetname = 'hugeNoisyTerrain'
filepath = '/data/hugeNoisyTerrain.vtp'
imgSavePath = '/data/img/'
...
data = XMLPolyDataReader(registrationName='hugeNoisyTerrain.vtp', FileName=[filepath])
...
data.PersistenceThreshold = 0.75
...
if sys.argv[1] == 'msc':
    ...
    tTKMorseSmaleComplex1_3Display = Show(OutputPort(msc, 3), view, 'GeometryRepresentation')
    ...
    morseSmaleManifoldLUT.RGBPoints = [0.0, 0.278431372549, 0.278431372549, 0.858823529412, 565.4219999999999, 0.0, 0.0, 0.360784313725, 1126.8899999999999, 0.0, 1.0, 1.0, 1696.266, 0.0, 0.501960784314, 0.0, 2257.734, 1.0, 1.0, 0.0, 2823.156, 1.0, 0.380392156863, 0.0, 3388.578, 0.419607843137, 0.0, 0.0, 3954.0, 0.878431372549, 0.301960784314, 0.301960784314]
    ...
    tTKMorseSmaleComplex1_3Display.GaussianRadius = 0.05
    ...
    morseSmaleManifoldPWF.Points = [0.0, 0.0, 0.5, 0.0, 3954.0, 1.0, 0.5, 0.0]
    ...
    tTKMorseSmaleSegmentationPL1_3Display = Show(OutputPort(msspl, 3), view, 'GeometryRepresentation')

    # get color transfer function/color map for 'MorseSmaleManifold'
    morseSmaleManifoldLUT = GetColorTransferFunction('MorseSmaleManifold')
    morseSmaleManifoldLUT.RGBPoints = [0.0, 0.278431372549, 0.278431372549, 0.858823529412, 586.7289999999999, 0.0, 0.0, 0.360784313725, 1169.3549999999998, 0.0, 1.0, 1.0, 1760.187, 0.0, 0.501960784314, 0.0, 2342.8129999999996, 1.0, 1.0, 0.0, 2929.542, 1.0, 0.380392156863, 0.0, 3516.2709999999997, 0.419607843137, 0.0, 0.0, 4103.0, 0.878431372549, 0.301960784314, 0.301960784314]
    morseSmaleManifoldLUT.ColorSpace = 'RGB'
    morseSmaleManifoldLUT.ScalarRangeInitialized = 1.0
    ...
    tTKMorseSmaleSegmentationPL1_3Display.GaussianRadius = 0.05
    ...
    criticalityIndexLUTColorBar.Visibility = 1
    ...
    # get opacity transfer function/opacity map for 'MorseSmaleManifold'
    morseSmaleManifoldPWF = GetOpacityTransferFunction('MorseSmaleManifold')
    morseSmaleManifoldPWF.Points = [0.0, 0.0, 0.5, 0.0, 4103.0, 1.0, 0.5, 0.0]
    morseSmaleManifoldPWF.ScalarRangeInitialized = 1
